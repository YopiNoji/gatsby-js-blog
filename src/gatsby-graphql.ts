...
export type IndexQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'siteUrl' | 'description' | 'author' | 'email' | 'image' | 'twitterId' | 'githubId' | 'googleAdSense' | 'copyright' | 'lang' | 'charSet'>> }>, allMarkdownRemark: { edges: Array<{ node: { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'category' | 'lang' | 'date' | 'slug' | 'tags' | 'title'>> } }> } };
...
export type PostQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'siteUrl' | 'description' | 'author' | 'email' | 'image' | 'twitterId' | 'githubId' | 'googleAdSense' | 'copyright' | 'lang' | 'charSet'>> }>, markdownRemark?: Maybe<(
